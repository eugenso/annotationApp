...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        add(Permission.objects.get(name='Can add queue element'))
        add(Permission.objects.get(name='Can change queue element'))
        add(Permission.objects.get(name='Can delete queue element'))
        add(Permission.objects.get(name='Can add score'))
        add(Permission.objects.get(name='Can change score'))
        add(Permission.objects.get(name='Can delete score'))
        annotators.save()
